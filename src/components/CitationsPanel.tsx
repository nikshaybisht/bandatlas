  ...
  return (
    <div className="citations-panel">
      ...
      <p className="cite-lead">
        Spectral traces in BandAtlas are labeled by quality. Teaching envelopes are for
      ...
      <p className="cite-how">
        Suggested software citation: Bisht, N. (2026). <em>BandAtlas</em> (v0.5.0). GitHub.{' '}
        <a href="https://github.com/nikshaybisht/bandatlas">
